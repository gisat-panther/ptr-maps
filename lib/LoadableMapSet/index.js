...
var LoadableMapSet = (0, _reactLoadable["default"])({
  loader: function loader() {
    return _ptrCore.isServer ? Promise.resolve().then(function () {
      ...
      return _interopRequireWildcard(require('../MapSet/index.js'));
    });
  },
  render: function render(loaded, props) {
    var MapSet = loaded["default"];
    return /*#__PURE__*/_react["default"].createElement(MapSet, props);
  },
...
var isomorphicMapSet = function isomorphicMapSet(props) {
  return _ptrCore.isServer ? /*#__PURE__*/_react["default"].createElement(_presentationEmpty["default"], null) : /*#__PURE__*/_react["default"].createElement(LoadableMapSet, props);
};

var _default = isomorphicMapSet;
