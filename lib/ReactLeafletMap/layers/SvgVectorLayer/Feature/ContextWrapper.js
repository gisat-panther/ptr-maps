    ...
    _createClass(_class, [{
      ...
      value: function render() {
        if (this.props.fid && this.context && this.context.hoveredItems) {
          this.hoveredFromContext = (0, _lodash.indexOf)(this.context.hoveredItems, this.props.fid) !== -1;
        } // TODO interactive without context case?


        if (this.context && this.props.hoverable) {
          return /*#__PURE__*/_react["default"].createElement(WrappedFeature, _extends({}, this.props, {
            changeContext: this.changeContext,
            hoveredFromContext: this.hoveredFromContext
          }));
        } else {
          return /*#__PURE__*/_react["default"].createElement(WrappedFeature, this.props);
        }
      }
    }]);

    return _class;
  }(_react["default"].PureComponent), _class.contextType = HoverContext, _temp;
}