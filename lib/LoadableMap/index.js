...
var LoadableMap = (0, _reactLoadable["default"])({
  loader: function loader() {
    return _ptrCore.isServer ? Promise.resolve().then(function () {
      ...
      return _interopRequireWildcard(require('../Map'));
    });
  },
  render: function render(loaded, props) {
    var PresentationMap = loaded["default"];
    return /*#__PURE__*/_react["default"].createElement(PresentationMap, props);
  },
...
var isomorphicMap = function isomorphicMap(props) {
  return _ptrCore.isServer ? /*#__PURE__*/_react["default"].createElement(_presentationEmpty["default"], null) : /*#__PURE__*/_react["default"].createElement(LoadableMap, props);
};

var _default = isomorphicMap;
