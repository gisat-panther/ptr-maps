...
if (!isServer) {
	...
	var CanvasLayer = require('leaflet').CanvasLayer;
	var CanvasLayer = require('leaflet').CanvasLayer;
}
...
let LeafletCanvasLayer = null;

if (!isServer) {
	LeafletCanvasLayer = CanvasLayer.extend({
		...
		prepareFeatures: function (features) {
			...
			_.forEach(features, feature => {
				...
				const defaultStyle = helpers.getDefaultStyleObject(
					feature,
					props.style
				);
