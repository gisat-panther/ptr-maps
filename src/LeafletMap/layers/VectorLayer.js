...
class VectorLayer extends React.PureComponent {
	...
	getLayerStyle(feature) {
		...
		let fillColor = constants.vectorLayerDefaultFeatureStyle.fillColor;
		...
		return {
			...
			fillOpacity: (propStyle && propStyle.fillOpacity) || constants.vectorLayerDefaultFeatureStyle.fillOpacity,
			fillColor,
			weight: (propStyle && propStyle.strokeWidth) || constants.vectorLayerDefaultFeatureStyle.strokeWidth,
			color: (propStyle && propStyle.strokeColor) || constants.vectorLayerDefaultFeatureStyle.strokeColor
		};
	}
	...
	highlightFeature(feature) {
		feature.setStyle({
			color: constants.vectorLayerHighlightedFeatureStyle.strokeColor || feature.options.color,
			fillOpacity: constants.vectorLayerHighlightedFeatureStyle.fillOpacity  || feature.options.fillOpacity,
			fillColor: constants.vectorLayerHighlightedFeatureStyle.fillColor || feature.options.fillColor,
			weight: constants.vectorLayerHighlightedFeatureStyle.strokeWidth || feature.options.weight
		});
	}
