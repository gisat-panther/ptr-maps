...
var ptrAtoms = require('@gisatcz/ptr-atoms');
var classnames = require('classnames');
var ptrCore = require('@gisatcz/ptr-core');
var utils = require('@gisatcz/ptr-utils');
...
var helpers$2 = require('@turf/helpers');
...
var Context = require('@gisatcz/cross-package-react-context');
...
var jsQuadtree = require('js-quadtree');
...
var _mapValues2__default = /*#__PURE__*/_interopDefaultLegacy(_mapValues2);
...
var _orderBy2__default = /*#__PURE__*/_interopDefaultLegacy(_orderBy2);
var _includes2__default = /*#__PURE__*/_interopDefaultLegacy(_includes2);
...
var _uniq2__default = /*#__PURE__*/_interopDefaultLegacy(_uniq2);
...
var WorldWind__default = /*#__PURE__*/_interopDefaultLegacy(WorldWind);
var uriTemplates__default = /*#__PURE__*/_interopDefaultLegacy(uriTemplates);
var _each2__default = /*#__PURE__*/_interopDefaultLegacy(_each2);
var _compact2__default = /*#__PURE__*/_interopDefaultLegacy(_compact2);
var turfCentroid__default = /*#__PURE__*/_interopDefaultLegacy(turfCentroid);
...
function isBoxRangeInRange(boxRange, range) {
  if (_isArray2__default['default'](range)) {
...
var GoToPlace = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(GoToPlace, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/React__default['default'].createElement(ptrAtoms.Input, {
        placeholder: "Zoom to",
        onChange: this.onTextChange,
        value: this.state.text
      }, /*#__PURE__*/React__default['default'].createElement(ptrAtoms.Icon, {
        icon: "search"
      })));
    }
  }]);
...
GoToPlace.propTypes = {
  goToPlace: PropTypes__default['default'].func
};
    ...
    value: function renderMaps() {
      ...
      if (this.props.children.length && availableWidth && availableHeight) {
        ...
        return this.props.children.map(function (map, index) {
          ...
          var wrapperClasses = classnames__default['default']('ptr-map-grid-cell', 'row' + rowNo, 'col' + colNo, map.props.wrapperClasses);
          return /*#__PURE__*/React__default['default'].createElement("div", {
  ...
  _createClass(MapControls, [{
    ...
    value: function isZoomButtonActive(type) {
      ...
      if (this.props.levelsBased) {
        var currentLevel = utils.map.view.getZoomLevelFromBoxRange(currentBoxRange, this.props.mapWidth, this.props.mapHeight);

        if (type === 'in') {
          var maxZoom = ptrCore.mapConstants.defaultLevelsRange[1];

          if (definedLimits && definedLimits[0]) {
            var definedLimitAsLevel = utils.map.view.getZoomLevelFromBoxRange(definedLimits[0], this.props.mapWidth, this.props.mapHeight);
          ...
          var minZoom = ptrCore.mapConstants.defaultLevelsRange[0];

          if (definedLimits && definedLimits[1]) {
            var _definedLimitAsLevel = utils.map.view.getZoomLevelFromBoxRange(definedLimits[1], this.props.mapWidth, this.props.mapHeight);
        ...
        if (type === 'in') {
          var limit = definedLimits && definedLimits[0] || ptrCore.mapConstants.minBoxRange;
          return currentBoxRange * (1 - this.zoomIncrement) >= limit;
        } else {
          var _limit = definedLimits && definedLimits[1] || ptrCore.mapConstants.maxBoxRange;
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default['default'].createElement("div", {
      ...
      }, /*#__PURE__*/React__default['default'].createElement(ptrAtoms.Button, {
        ...
        icon: "minus-thick"
      }))), !this.props.zoomOnly ? /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement("div", {
...
MapControls.propTypes = {
  view: PropTypes__default['default'].object,
  viewLimits: PropTypes__default['default'].object,
  updateView: PropTypes__default['default'].func,
  resetHeading: PropTypes__default['default'].func,
  mapKey: PropTypes__default['default'].string,
  zoomOnly: PropTypes__default['default'].bool,
  levelsBased: PropTypes__default['default'].oneOfType([PropTypes__default['default'].bool, PropTypes__default['default'].array]),
  mapHeight: PropTypes__default['default'].number,
  mapWidth: PropTypes__default['default'].number
};
...
var MapWrapper = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(MapWrapper, [{
    ...
    value: function render() {
      ...
      var wrapperClasses = classnames__default['default']('ptr-map-wrapper', {
...
MapWrapper.propTypes = {
  ...
  title: PropTypes__default['default'].oneOfType([PropTypes__default['default'].bool, PropTypes__default['default'].string]),
  onMapRemove: PropTypes__default['default'].func
};
...
var MapSet = /*#__PURE__*/function (_React$PureComponent3) {
  ...
  function MapSet(props) {
    ...
    if (!props.stateMapSetKey) {
      _this.state = {
        view: utils.map.view.mergeViews(ptrCore.mapConstants.defaultMapView, props.view),
        activeMapKey: props.activeMapKey,
        mapViews: {},
        mapsDimensions: {}
      };

      _forEach2__default['default'](_this.props.children, function (child) {
        if (child && _typeof(child) === 'object' && (child.type === Map || child.type === _this.props.connectedMapComponent || child.type === PresentationMap) && child.props.mapKey === props.activeMapKey) {
          _this.state.mapViews[child.props.mapKey] = utils.map.view.mergeViews(ptrCore.mapConstants.defaultMapView, props.view, child.props.view);
        }
      });
    } else {
      _this.state = {
  ...
  _createClass(MapSet, [{
    ...
    value: function componentDidUpdate(prevProps, prevState, snapshot) {
      ...
      if (!props.stateMapSetKey) {
        if (prevProps.view !== props.view) {
          var mapViews = _mapValues2__default['default'](this.state.mapViews, function (view) {
    ...
    value: function onViewChange(mapKey, update) {
      ...
      var syncUpdate;
      update = utils.map.view.ensureViewIntegrity(update);
      mapKey = mapKey || this.state.activeMapKey;

      if (this.props.sync) {
        syncUpdate = _pickBy2__default['default'](update, function (updateVal, updateKey) {
          return _this2.props.sync[updateKey];
        });
        syncUpdate = utils.map.view.ensureViewIntegrity(syncUpdate);
      } // merge views of all maps


      var mapViews = _mapValues2__default['default'](this.state.mapViews, function (view) {
        return utils.map.view.mergeViews(view, syncUpdate);
      }); // merge views of given map


      mapViews[mapKey] = utils.map.view.mergeViews(this.state.mapViews[mapKey], update);

      if (syncUpdate && !_isEmpty2__default['default'](syncUpdate)) {
        var mergedView = utils.map.view.mergeViews(this.state.view, syncUpdate);
        this.setState({
          view: mergedView,
          mapViews: mapViews
        });
    ...
    value: function onResetHeading() {
      ...
      utils.map.resetHeading(this.state.mapViews[this.state.activeMapKey].heading, function (heading) {
    ...
    value: function render() {
      ...
      }, this.renderMaps()), /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    value: function renderControls() {
      ...
      if (this.props.stateMapSetKey) {
        ...
        view = utils.map.view.mergeViews(this.state.view, this.state.mapViews[this.state.activeMapKey]);
      ...
      return React__default['default'].Children.map(this.props.children, function (child) {
    ...
    value: function renderMaps() {
      ...
      if (this.props.stateMapSetKey) {
        ...
        React__default['default'].Children.map(this.props.children, function (child, index) {
          ...
          var props = _objectSpread2(_objectSpread2({}, restProps), {}, {
            key: index,
            view: utils.map.view.mergeViews(_this4.state.view, view, _this4.state.mapViews[mapKey]),
            backgroundLayer: backgroundLayer || _this4.props.backgroundLayer,
            layers: utils.map.mergeLayers(_this4.props.layers, layers),
      ...
      return /*#__PURE__*/React__default['default'].createElement(MapGrid, null, maps);
    }
  }, {
    key: "renderMap",
    value: function renderMap(mapComponent, props, children, active, renderWrapper) {
      ...
      if (this.props.wrapper) {
        ...
        if (renderWrapper) {
          ...
          return /*#__PURE__*/React__default['default'].createElement(wrapperComponent, allProps, /*#__PURE__*/React__default['default'].createElement(mapComponent, props, children));
        } else {
          return /*#__PURE__*/React__default['default'].createElement(mapComponent, allProps, children);
        }
      } else {
        return /*#__PURE__*/React__default['default'].createElement(mapComponent, props, children);
      }
    }
  }]);
...
MapSet.propTypes = {
  activeMapKey: PropTypes__default['default'].string,
  activeMapView: PropTypes__default['default'].object,
  activeMapViewport: PropTypes__default['default'].object,
  disableMapRemoval: PropTypes__default['default'].bool,
  mapSetKey: PropTypes__default['default'].string,
  maps: PropTypes__default['default'].array,
  mapComponent: PropTypes__default['default'].func,
  view: PropTypes__default['default'].object,
  stateMapSetKey: PropTypes__default['default'].string,
  sync: PropTypes__default['default'].object,
  wrapper: PropTypes__default['default'].oneOfType([PropTypes__default['default'].elementType, PropTypes__default['default'].element, PropTypes__default['default'].bool]),
...
var PresentationMap$1 = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function PresentationMap(props) {
    ...
    if (!props.stateMapKey) {
      _this.state.view = _objectSpread2(_objectSpread2({}, ptrCore.mapConstants.defaultMapView), props.view);
    }
  ...
  _createClass(PresentationMap, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (props.view) {
        ...
        if (prevProps && prevProps.view) {
          //todo simplify
          if (!_isEqual2__default['default'](props.view, prevProps.view)) {
    ...
    value: function getValidView(update) {
      var view = _objectSpread2(_objectSpread2({}, ptrCore.mapConstants.defaultMapView), view);

      if (this.state.view && !_isEmpty2__default['default'](this.state.view)) {
        view = _objectSpread2(_objectSpread2({}, this.state.view), update);
      }

      view = utils.map.view.ensureViewIntegrity(view);
      return view;
    }
  }, {
    key: "saveViewChange",
    value: function saveViewChange(view, checkViewEquality) {
      if (checkViewEquality && !_isEqual2__default['default'](view, this.state.view)) {
        if (!this.props.stateMapKey) {
          this.setState({
            view: view
          });
    ...
    value: function onViewChange(update) {
      ...
      if (!_isEqual2__default['default'](view, this.state.view)) {
    ...
    value: function resetHeading() {
      ...
      utils.map.resetHeading(this.state.view.heading, function (heading) {
    ...
    value: function render() {
      ...
      if (!mapComponent) {
        return /*#__PURE__*/React__default['default'].createElement(ptrAtoms.Error, {
          centered: true
        ...
        if (wrapper) {
          var wrapperComponent = this.props.wrapper.prototype && this.props.wrapper.prototype.isReactComponent || typeof this.props.wrapper === 'function' ? this.props.wrapper : MapWrapper;
          return /*#__PURE__*/React__default['default'].createElement(wrapperComponent, _objectSpread2(_objectSpread2({}, props), wrapperProps), this.renderContent(mapComponent, props, children));
        } else {
    ...
    value: function renderContent(mapComponent, props, children) {
      ...
      var map = /*#__PURE__*/React__default['default'].createElement(mapComponent, props);
      ...
      if (!children) {
        ...
        }, map, React__default['default'].Children.map(children, function (child) {
...
PresentationMap$1.propTypes = {
  backgroundLayer: PropTypes__default['default'].oneOfType([PropTypes__default['default'].array, PropTypes__default['default'].object]),
  children: PropTypes__default['default'].element,
  layers: PropTypes__default['default'].array,
  mapComponent: PropTypes__default['default'].oneOfType([PropTypes__default['default'].element, PropTypes__default['default'].func]),
  onMount: PropTypes__default['default'].func,
  onPropViewChange: PropTypes__default['default'].func,
  onResize: PropTypes__default['default'].func,
  onViewChange: PropTypes__default['default'].func,
  resetHeading: PropTypes__default['default'].func,
  stateMapKey: PropTypes__default['default'].string,
  view: PropTypes__default['default'].object,
  viewport: PropTypes__default['default'].object,
  viewLimits: PropTypes__default['default'].object,
  wrapper: PropTypes__default['default'].oneOfType([PropTypes__default['default'].elementType, PropTypes__default['default'].element, PropTypes__default['default'].bool]),
  wrapperProps: PropTypes__default['default'].object
};
...
function getLeafletViewFromViewParams(view, width, height) {
  var completeView = _objectSpread2(_objectSpread2({}, ptrCore.mapConstants.defaultMapView), view);

  return {
    zoom: utils.map.view.getZoomLevelFromBoxRange(completeView.boxRange, width, height),
    center: {
...
var svg = (function (props) {
  ...
  return /*#__PURE__*/React__default['default'].createElement("svg", {
    ...
    style: props.style
  }, /*#__PURE__*/React__default['default'].createElement(props.children, _objectSpread2(_objectSpread2({}, props), {}, {
    offset: offset
  })));
});
...
var Cross$1 = (function (props) {
  return /*#__PURE__*/React__default['default'].createElement(svg, props, Cross);
});
...
var Pin = function Pin(props) {
  ...
  }), props.icon ? /*#__PURE__*/React__default['default'].createElement("g", {
    transform: "translate(9 3.5) scale(0.4375 0.4375)"
  }, props.icon) : null);
};

var Pin$1 = (function (props) {
  return /*#__PURE__*/React__default['default'].createElement(svg, props, Pin);
});
  ...
  _createClass(MarkerShape, [{
    ...
    value: function getShapeHtml() {
      ...
      if (this.basicShape) {
        ...
        return ReactDOMServer__default['default'].renderToString( /*#__PURE__*/React__default['default'].createElement("div", {
          style: style
        }));
      } else {
        var finalShape;
        ...
        return ReactDOMServer__default['default'].renderToString(finalShape);
      }
    }
    /**
    ...
    value: function getShape(style) {
      ...
      return /*#__PURE__*/React__default['default'].createElement(this.shape.component, _objectSpread2(_objectSpread2({}, props), {}, {
    ...
    value: function getIcon(style) {
      ...
      return /*#__PURE__*/React__default['default'].createElement(this.icon.component, props);
    }
    /**
     * @param style {Object} style object suitable for SVG
     * @return {React.DetailedReactHTMLElement<React.InputHTMLAttributes<HTMLInputElement>, HTMLInputElement>}
    ...
    value: function getShapeWithIcon(style) {
      ...
      var iconComponent = /*#__PURE__*/React__default['default'].createElement(this.icon.component, iconProps);
      var props = this.shape.componentProps ? _objectSpread2(_objectSpread2({}, this.shape.componentProps), {}, {
        style: shapeStyle
      }) : {
        style: shapeStyle
    ...
    value: function setStyle(style, id, isBasicShape) {
      ...
      if (shape) {
        _forIn2__default['default'](shapeStyle, function (value, key) {
...
function getDefaultStyleObject(feature, styleDefinition) {
  return utils.mapStyle.getStyleObject(feature.properties, styleDefinition || constants.vectorFeatureStyle.defaultFull);
}
/**
...
var convertCoordinatesMemo = memoize__default['default'](function (feature) {
  // TODO do we need turf for this?
  var flippedFeature = flip__default['default'](feature);
...
var calculateStylesMemo = memoize__default['default'](calculateStyle);
/**
 * @param id {string}
 * @param style {Object} Leaflet style definition
...
var getMarkerShapeSquareStyle = function getMarkerShapeSquareStyle(leafletStyle, rotation, borderRadius) {
  ...
  if (leafletStyle.fillColor) {
    if (leafletStyle.fillOpacity && leafletStyle.fillOpacity !== 1) {
      var rgb = utils.mapStyle.hexToRgb(leafletStyle.fillColor);
  ...
  if (leafletStyle.color) {
    if (leafletStyle.opacity && leafletStyle.opacity !== 1) {
      var _rgb = utils.mapStyle.hexToRgb(leafletStyle.color);
...
L$1.DomUtil.setTransform = L$1.DomUtil.setTransform || function (el, offset, scale) {
  var pos = offset || new L$1.Point(0, 0);
  el.style[L$1.DomUtil.TRANSFORM] = (L$1.Browser.ie3d ? 'translate(' + pos.x + 'px,' + pos.y + 'px)' : 'translate3d(' + pos.x + 'px,' + pos.y + 'px,0)') + (scale ? ' scale(' + scale + ')' : '');
}; // -- support for both  0.0.7 and 1.0.0 rc2 leaflet


var CanvasLayer = (L$1.Layer ? L$1.Layer : L$1.Class).extend({
  ...
  _animateZoom: function _animateZoom(e) {
    ...
    var offset = L$1.Layer ? this._map._latLngBoundsToNewLayerBounds(this._map.getBounds(), e.zoom, e.center).min : this._map._getCenterOffset(e.center)._multiplyBy(-scale).subtract(this._map._getMapPanePos());
...
function setPolygonStyle(context, style) {
  if (style.fill) {
    ...
    if (style.fillOpacity) {
      context.fillStyle = chroma__default['default'](style.fill).alpha(style.fillOpacity).hex();
    }
  ...
  if (style.outlineColor && style.outlineWidth) {
    ...
    if (style.outlineOpacity) {
      context.strokeStyle = chroma__default['default'](style.outlineColor).alpha(style.outlineOpacity).hex();
    }
...
var LeafletCanvasLayer = CanvasLayer.extend({
  ...
  onLayerClick: function onLayerClick(e) {
    ...
    if (this.props.selectable) {
      ...
      if (_isArray2__default['default'](this.features)) {
        this.features.forEach(function (feature) {
          var type = feature.original.geometry.type;

          if (type === 'Point') {
            var radius = feature.defaultStyle.size;
            var LatLngBounds = L$1.latLngBounds(_this._map.containerPointToLatLng(mousePoint.add(L$1.point(radius, radius))), _this._map.containerPointToLatLng(mousePoint.subtract(L$1.point(radius, radius))));
            ...
            var point = _this._map.containerPointToLatLng(L$1.point(mousePoint.x, mousePoint.y));

            var pointFeature = helpers$2.point([point.lng, point.lat]);
            var insidePolygon = booleanPointInPolygon__default['default'](pointFeature, feature.original.geometry);
        ...
        if (pointsInsideBounds.length) {
          ...
          var nearest = nearestPoint__default['default'](helpers$2.point([position.lng, position.lat]), {
  ...
  prepareFeatures: function prepareFeatures(features) {
    ...
    _forEach2__default['default'](features, function (feature) {
      ...
      if (props.selected && fid) {
        _forIn2__default['default'](props.selected, function (selection, key) {
          if (selection.keys && _includes2__default['default'](selection.keys, fid)) {
    ...
    if (pointFeatures.length) {
      return _orderBy2__default['default'](pointFeatures, ['defaultStyle.size', 'fid'], ['desc', 'asc']);
    } else if (polygonFeatures.length) {
      if (props.selected) {
        return _orderBy2__default['default'](polygonFeatures, ['selected'], ['desc']);
      } else {
        return polygonFeatures;
      }
    } else if (lineFeatures.length) {
      if (props.selected) {
        return _orderBy2__default['default'](lineFeatures, ['selected'], ['desc']);
      } else {
        return lineFeatures;
      }
    } else {
  ...
  renderOffScreen: function renderOffScreen(params) {
    ...
    if (!params.layer.props.pointAsMarker) {
      pixelSizeInMeters = ptrCore.mapConstants.getPixelSizeInLevelsForLatitude(ptrCore.mapConstants.pixelSizeInLevels, 0)[params.zoom];
    } // redraw all features
    ...
    for (var i = 0; i < this.features.length; i++) {
      ...
      var omitFeature = ((_this$props$omittedFe = this.props.omittedFeatureKeys) === null || _this$props$omittedFe === void 0 ? void 0 : _this$props$omittedFe.length) && _includes2__default['default'](this.props.omittedFeatureKeys, feature.fid);
...
var CanvasVectorLayer$1 = reactLeaflet.withLeaflet(CanvasVectorLayer);
...
function getBoundingBox(view, width, height, crs, optLat) {
  ...
  if (!crs || crs === 'EPSG:3857') {
    ...
    var calculatedBoxRange = utils.map.view.getNearestZoomLevelBoxRange(width, height, view.boxRange);

    if (boxRange !== calculatedBoxRange) {
      boxRange = calculatedBoxRange;
    }

    return utils.map.view.getBoundingBoxFromViewForEpsg3857(view.center, boxRange, width / height, optLat);
  } else {
    return {
      minLat: -90,
      maxLat: 90,
...
var IndexedVectorLayer = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function IndexedVectorLayer(props) {
    ...
    _this.repopulateIndexTreeIfNeeded = memoize__default['default'](function (features) {
      if (features) {
  ...
  _createClass(IndexedVectorLayer, [{
    ...
    value: function render() {
      ...
      if (props.features && this.boxRangeFitsLimits()) {
        ...
        var bbox = getBoundingBox(view, width, height, crs, ptrCore.mapConstants.averageLatitude);
        var geoJsonBbox = {
          type: 'Feature',
...
IndexedVectorLayer.propTypes = {
  boxRangeRange: PropTypes__default['default'].array,
  component: PropTypes__default['default'].oneOfType([PropTypes__default['default'].func, PropTypes__default['default'].object]),
  omittedFeatureKeys: PropTypes__default['default'].array
};

var HoverContext = Context__default['default'].getContext('HoverContext');
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        if (this.props.fid && this.context && this.context.hoveredItems) {
          this.hoveredFromContext = _indexOf2__default['default'](this.context.hoveredItems, this.props.fid) !== -1;
        } // TODO interactive without context case?


        if (this.context && this.props.hoverable) {
          return /*#__PURE__*/React__default['default'].createElement(WrappedFeature, _extends({}, this.props, {
            changeContext: this.changeContext,
            hoveredFromContext: this.hoveredFromContext
          }));
        } else {
          return /*#__PURE__*/React__default['default'].createElement(WrappedFeature, this.props);
        }
      }
    }]);

    return _class;
  }(React__default['default'].PureComponent), _class.contextType = HoverContext, _temp;
}
...
var Feature = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Feature(props) {
    ...
    if (props.type === 'Point' && props.pointAsMarker) {
      _this.shapeId = _this.props.uniqueFeatureKey ? "".concat(_this.props.uniqueFeatureKey, "_icon") : utils.utils.uuid();
    }
  ...
  _createClass(Feature, [{
    ...
    value: function renderPolygon(coordinates, style) {
      return /*#__PURE__*/React__default['default'].createElement(reactLeaflet.Polygon, _extends({
    ...
    value: function renderLine(coordinates, style) {
      return /*#__PURE__*/React__default['default'].createElement(reactLeaflet.Polyline, _extends({
        interactive: this.props.hoverable || this.props.selectable,
        onAdd: this.onAdd,
        onClick: this.onClick,
    ...
    value: function renderPoint(coordinates, style) {
      if (this.props.pointAsMarker) {
        ...
        return /*#__PURE__*/React__default['default'].createElement(reactLeaflet.Circle, _extends({
          interactive: this.props.hoverable || this.props.selectable,
          onAdd: this.onAdd,
          onClick: this.onClick,
          onMouseMove: this.onMouseMove,
    ...
    value: function renderShape(coordinates, style) {
      ...
      if (!shallowEqual.shallowEqualObjects(this.style, style)) {
        this.style = style;
...
Feature.propTypes = {
  feature: PropTypes__default['default'].object,
  fid: PropTypes__default['default'].oneOfType([PropTypes__default['default'].string, PropTypes__default['default'].number]),
  fidColumnName: PropTypes__default['default'].string,
  hoverable: PropTypes__default['default'].bool,
  hoveredFromContext: PropTypes__default['default'].bool,
  hoveredStyleDefinition: PropTypes__default['default'].oneOfType([PropTypes__default['default'].string, PropTypes__default['default'].object]),
  selectable: PropTypes__default['default'].bool,
  selected: PropTypes__default['default'].bool,
  selectedStyleDefinition: PropTypes__default['default'].oneOfType([PropTypes__default['default'].string, PropTypes__default['default'].object]),
  selectedHoveredStyleDefinition: PropTypes__default['default'].oneOfType([PropTypes__default['default'].string, PropTypes__default['default'].object]),
  changeContext: PropTypes__default['default'].func,
  interactive: PropTypes__default['default'].bool,
  styleDefinition: PropTypes__default['default'].object
};
...
var GeoJsonLayer = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function GeoJsonLayer(props) {
    ...
    _this.getRenderId = memoize__default['default'](function (features) {
      if (features) {
        return utils.utils.uuid();
      }
    });
    return _this;
  }
  ...
  _createClass(GeoJsonLayer, [{
    ...
    value: function pointToLayer(feature, coord) {
      if (this.props.pointAsMarker) {
        ...
        if (!((_style = style) !== null && _style !== void 0 && _style.shape) && !((_style2 = style) !== null && _style2 !== void 0 && _style2.icon) || ((_style3 = style) === null || _style3 === void 0 ? void 0 : _style3.shape) === 'circle') {
          return L__default['default'].circleMarker(coord, _objectSpread2(_objectSpread2({}, feature.defaultStyle), {}, {
          ...
          var shapeId = feature.uniqueFeatureKey ? "".concat(feature.uniqueFeatureKey, "_icon") : utils.utils.uuid();
          var shape = helpers.getMarkerShape(shapeId, style, {
            icons: this.props.icons
          });
          return L__default['default'].marker(coord, {
            pane: this.props.paneName,
            interactive: this.props.hoverable || this.props.selectable,
            icon: shape
          });
        ...
        return L__default['default'].circle(coord, feature.defaultStyle);
      }
    }
  }, {
    key: "filter",
    value: function filter(feature) {
      if (this.props.omittedFeatureKeys) {
        ...
        return !(featureKey && _includes2__default['default'](this.props.omittedFeatureKeys, featureKey));
      } else {
        return true;
      }
    }
...
GeoJsonLayer.propTypes = {
  omittedFeatureKeys: PropTypes__default['default'].array // list of feature keys that shouldn't be rendered

};
var GeoJsonLayer$1 = reactLeaflet.withLeaflet(GeoJsonLayer);
...
var SvgVectorLayer = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function SvgVectorLayer(props) {
    ...
    _this = _super.call(this, props);
    _this.pointsPaneName = utils.utils.uuid();
    _this.linesPaneName = utils.utils.uuid();
    _this.polygonsPaneName = utils.utils.uuid();
  ...
  _createClass(SvgVectorLayer, [{
    ...
    value: function prepareData(features) {
      ...
      if (features) {
        ...
        _forEach2__default['default'](features, function (feature) {
          ...
          if (type) {
            ...
            if (_this2.props.selected && fid) {
              _forIn2__default['default'](_this2.props.selected, function (selection, key) {
                if (selection.keys && _includes2__default['default'](selection.keys, fid)) {
                  selected = selection;
                }
              });
        ...
        if (pointFeatures.length) {
          sortedPointFeatures = _orderBy2__default['default'](pointFeatures, ['defaultStyle.radius', 'fid'], ['desc', 'asc']);
        } // sort polygon features, if selected


        if (polygonFeatures.length) {
          if (this.props.selected) {
            sortedPolygonFeatures = _orderBy2__default['default'](polygonFeatures, ['selected'], ['asc']);
          } else {
    ...
    value: function render() {
      ...
      return data ? /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, (_data$polygons = data.polygons) !== null && _data$polygons !== void 0 && _data$polygons.length ? /*#__PURE__*/React__default['default'].createElement(reactLeaflet.Pane, {
        className: classes,
        style: style,
        name: this.polygonsPaneName
      }, this.renderFeatures(data.polygons)) : null, (_data$lines = data.lines) !== null && _data$lines !== void 0 && _data$lines.length ? /*#__PURE__*/React__default['default'].createElement(reactLeaflet.Pane, {
        className: classes,
        style: style,
        name: this.linesPaneName
      }, this.renderFeatures(data.lines)) : null, (_data$points = data.points) !== null && _data$points !== void 0 && _data$points.length ? /*#__PURE__*/React__default['default'].createElement(reactLeaflet.Pane, {
        className: classes,
        style: style,
    ...
    value: function renderGeoJson(features) {
      ...
      return /*#__PURE__*/React__default['default'].createElement(GeoJsonLayer$1, {
    ...
    value: function renderFeature(data, index) {
      ...
      return /*#__PURE__*/React__default['default'].createElement(Feature$1, {
        key: key,
...
SvgVectorLayer.propTypes = {
  layerKey: PropTypes__default['default'].string,
  uniqueLayerKey: PropTypes__default['default'].string,
  // typically a combination of layerKey and data source key (or just layerKey, if no data source)
  renderAsGeoJson: PropTypes__default['default'].bool,
  // Use Leaflet's GeoJSON layer to render vector features
  features: PropTypes__default['default'].array,
  fidColumnName: PropTypes__default['default'].string,
  omittedFeatureKeys: PropTypes__default['default'].array,
  selectable: PropTypes__default['default'].bool,
  selected: PropTypes__default['default'].object,
  hoverable: PropTypes__default['default'].bool,
  hovered: PropTypes__default['default'].object,
  style: PropTypes__default['default'].object,
  pointAsMarker: PropTypes__default['default'].bool,
  onClick: PropTypes__default['default'].func,
  withSelectedFeaturesOnly: PropTypes__default['default'].bool // True, if layer contains only selected features
...
function getFeatureKeysToOmit(featureKeysGroupedByTileKey, tileKey, features, fidColumnName) {
  ...
  var indexOfCurrentTile = _findIndex2__default['default'](featureKeysGroupedByTileKey, function (tile) {
  ...
  if (indexOfCurrentTile > 0) {
    var _ret = function () {
      ...
      while (i < indexOfCurrentTile) {
        ...
        _forEach2__default['default'](tile.featureKeys, function (featureKey) {
...
function checkIdentity(prev, next) {
  ...
  if (!prevKeys && !nextKeys) {
    ...
    return _isEqual2__default['default'](prevKeys.sort(), nextKeys.sort());
  }
}
...
var Tile = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function Tile(props) {
    ...
    _this = _super.call(this, props);
    _this.getFeatureKeysToOmit = memoize__default['default'](getFeatureKeysToOmit); // return memoized feature keys, if nothing changed and not render IndexedVectorLayer again

    _this.checkIdentity = memoize__default['default'](function (keys) {
      return keys;
    }, checkIdentity);
    return _this;
  }
  ...
  _createClass(Tile, [{
    ...
    value: function render() {
      ...
      if (props.renderingTechnique === 'canvas') {
        return /*#__PURE__*/React__default['default'].createElement(CanvasVectorLayer$1, _extends({}, props, {
          key: tileKey,
          uniqueLayerKey: tileKey,
          omittedFeatureKeys: this.checkIdentity(omittedFeatureKeys)
        }));
      } else {
        return /*#__PURE__*/React__default['default'].createElement(IndexedVectorLayer, _extends({}, props, {
...
Tile.propTypes = {
  tileKey: PropTypes__default['default'].string,
  features: PropTypes__default['default'].array,
  fidColumnName: PropTypes__default['default'].string,
  level: PropTypes__default['default'].number,
  tile: PropTypes__default['default'].oneOfType([PropTypes__default['default'].array, PropTypes__default['default'].string]),
  featureKeysGroupedByTileKey: PropTypes__default['default'].array // a collection of all tiles and their features for each tile in the layer
...
function getFeaturesGroupedByTileKey(uniqueLayerKey, tiles, fidColumnName, selections) {
  ...
  _forEach2__default['default'](tiles, function (tile) {
    ...
    if (tile.features) {
      _forEach2__default['default'](tile.features, function (feature) {
        var fid = feature.id || feature.properties[fidColumnName];

        if (selections) {
          _forIn2__default['default'](selections, function (selection, selectionKey) {
            if (selection.keys && _includes2__default['default'](selection.keys, fid)) {
  ...
  if (!_isEmpty2__default['default'](selected)) {
    _forIn2__default['default'](selected, function (selection, selectionKey) {
      ...
      groupedFeatureKeys.unshift({
        key: key,
        featureKeys: _uniq2__default['default'](selection.featureKeys)
      });
    });
  }
...
var TiledVectorLayer = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function TiledVectorLayer(props) {
    ...
    _this = _super.call(this, props);
    _this.getFeaturesGroupedByTileKey = memoize__default['default'](getFeaturesGroupedByTileKey);
    return _this;
  }
    ...
    value: function render() {
      ...
      if ((_data$groupedFeatures = data.groupedFeatures) !== null && _data$groupedFeatures !== void 0 && _data$groupedFeatures.length) {
        return data.groupedFeatures.map(function (tile) {
          return /*#__PURE__*/React__default['default'].createElement(Tile, _extends({}, props, {
            key: tile.key,
            tileKey: tile.key,
...
TiledVectorLayer.propTypes = {
  fidColumnName: PropTypes__default['default'].string,
  tiles: PropTypes__default['default'].array,
  layerKey: PropTypes__default['default'].string,
  uniqueLayerKey: PropTypes__default['default'].string
};
  ...
  _createClass(VectorLayer, [{
    ...
    value: function getOptions() {
      ...
      if (renderAs) {
        ...
        var renderAsData = _find2__default['default'](renderAs, function (renderAsItem) {
    ...
    value: function renderTiledVectorLayer(options) {
      ...
      return /*#__PURE__*/React__default['default'].createElement(TiledVectorLayer, _extends({}, props, options));
    }
  }, {
    ...
    value: function renderBasicVectorLayer(options) {
      ...
      if (options.renderingTechnique === 'canvas') {
        return /*#__PURE__*/React__default['default'].createElement(CanvasVectorLayer$1, _extends({}, props, options));
      } else {
        return /*#__PURE__*/React__default['default'].createElement(IndexedVectorLayer, _extends({
          component: SvgVectorLayer
        }, props, options));
      }
    }
...
VectorLayer.propTypes = {
  layerKey: PropTypes__default['default'].string,
  uniqueLayerKey: PropTypes__default['default'].oneOfType([PropTypes__default['default'].number, PropTypes__default['default'].string]),
  onClick: PropTypes__default['default'].func,
...
wms.Source = L$1.Layer.extend({
  ...
  getFeatureInfo: function getFeatureInfo(point, latlng, layers, callback) {
    ...
    var params = this.getFeatureInfoParams(point, layers),
        url = this._url + L$1.Util.getParamString(params, this._url);
    this.showWaiting();
    this.ajax(url, done);
  ...
  getFeatureInfoParams: function getFeatureInfoParams(point, layers) {
    ...
    return L$1.extend({}, wmsParams, infoParams);
  },
...
wms.TileLayer = L$1.TileLayer.WMS;
wms.tileLayer = L$1.tileLayer.wms;
/*
 * wms.Overlay:
...
wms.Overlay = L$1.Layer.extend({
  ...
  initialize: function initialize(url, options) {
    ...
    L$1.setOptions(this, opts);
    this.wmsParams = L$1.extend({}, this.defaultWmsParams, params);
  },
  setParams: function setParams(params) {
    L$1.extend(this.wmsParams, params);
    this.update();
  },
  ...
  update: function update() {
    ...
    var overlay = L$1.imageOverlay(url, bounds, {
      opacity: 0,
  ...
  updateWmsParams: function updateWmsParams(map) {
    ...
    params.bbox = (wmsVersion >= 1.3 && crs === L$1.CRS.EPSG4326 ? [se.y, nw.x, nw.y, se.x] : [nw.x, se.y, se.x, nw.y]).join(',');
    L$1.extend(this.wmsParams, params);
  },
  getImageUrl: function getImageUrl() {
    var uppercase = this.options.uppercase || false;
    var pstr = L$1.Util.getParamString(this.wmsParams, this._url, uppercase);
  ...
  _createClass(WMSLayer, [{
    ...
    value: function createLeafletElement(props) {
      ...
      if (singleTile) {
        ...
        return new L$1.TileLayer.WMS(url, options);
      }
    }
  }, {
    key: "updateLeafletElement",
    value: function updateLeafletElement(fromProps, toProps) {
      ...
      if (!isEqual__default['default'](fromProps.params, toProps.params)) {
...
var WMSLayer$1 = reactLeaflet.withLeaflet(WMSLayer);

var getBoxRange = function getBoxRange(boxRange, width, height) {
  var calculatedBoxRange = utils.map.view.getNearestZoomLevelBoxRange(width, height, boxRange);
...
var TileGridLayer = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(TileGridLayer, [{
    ...
    value: function getGeoJsonTileGrid(tileGrid, boxRange, viewport) {
      ...
      var size = ptrTileGrid.utils.getGridSizeForLevel(level); // //consider caching levels

      var geojsonTileGrid = ptrTileGrid.utils.getTileGridAsGeoJSON(tileGrid, size);
      return geojsonTileGrid;
    }
  }, {
    key: "getTileGridLevel",
    value: function getTileGridLevel(boxRange, viewport) {
      var viewportRange = utils.map.view.getMapViewportRange(viewport.width, viewport.height);
      var nearestBoxRange = utils.map.view.getNearestZoomLevelBoxRange(viewport.width, viewport.height, boxRange);
      var level = ptrTileGrid.grid.getLevelByViewport(nearestBoxRange, viewportRange);
      return level;
    }
  }, {
    key: "getTilesMarkers",
    value: function getTilesMarkers() {
      ...
      var markers = tileGrid.reduce(function (acc, row) {
        var rowMarkers = row.map(function (tile, i) {
          return /*#__PURE__*/React__default['default'].createElement(reactLeaflet.Pane, {
            style: {
              zIndex: _this2.props.zIndex
            },
            key: "".concat(level, "-").concat(tile[0], "-").concat(tile[1])
          }, /*#__PURE__*/React__default['default'].createElement(reactLeaflet.Marker, {
            zIndex: _this2.props.zIndex,
    ...
    value: function renderBasicVectorLayer(options) {
      ...
      var tileGrid = ptrTileGrid.grid.getTileGrid(options.viewport.width, options.viewport.height, recalculatedBoxrange, props.view.center, true);
      ...
      return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(reactLeaflet.GeoJSON, {
        key: key,
...
var TileGridLayer$1 = reactLeaflet.withLeaflet(TileGridLayer);
...
var ReactLeafletMap = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(ReactLeafletMap, [{
    ...
    value: function componentDidMount() {
      ...
      var originalInitTile = L__default['default'].GridLayer.prototype._initTile;
      L__default['default'].GridLayer.include({
    ...
    value: function getCRS(code) {
      switch (code) {
        case 'EPSG:4326':
          return L__default['default'].CRS.EPSG4326;

        case 'EPSG:5514':
          return new Proj__default['default'].CRS('EPSG:5514', constants.projDefinitions.epsg5514, {
            resolutions: [102400, 51200, 25600, 12800, 6400, 3200, 1600, 800, 400, 200, 100, 50, 25, 12.5, 6.25, 3.125, 1.5625, 0.78125, 0.390625]
          });

        default:
          return L__default['default'].CRS.EPSG3857;
      }
    }
  }, {
    ...
    value: function setZoomLevelsBounds(width, height) {
      var props = this.props;
      this.minZoom = ptrCore.mapConstants.defaultLevelsRange[0];
      this.maxZoom = ptrCore.mapConstants.defaultLevelsRange[1];

      if (props.viewLimits && props.viewLimits.boxRangeRange) {
        if (props.viewLimits.boxRangeRange[1]) {
          this.minZoom = utils.map.view.getZoomLevelFromBoxRange(props.viewLimits.boxRangeRange[1], width, height);
        }

        if (props.viewLimits.boxRangeRange[0]) {
          this.maxZoom = utils.map.view.getZoomLevelFromBoxRange(props.viewLimits.boxRangeRange[0], width, height);
        }
      }
    }
  }, {
    ...
    value: function onViewportChanged(viewport) {
      if (viewport) {
        ...
        if (viewport.hasOwnProperty('zoom') && Number.isFinite(viewport.zoom) && viewport.zoom !== this.state.leafletView.zoom) {
          change.boxRange = utils.map.view.getBoxRangeFromZoomLevel(viewport.zoom, this.state.width, this.state.height);
        }

        if (!_isEmpty2__default['default'](change) && !this.hasResized()) {
          var _this$props$viewLimit2;

          change = utils.map.view.ensureViewIntegrity(change);
    ...
    key: "render",
    value: function render() {
      return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(ReactResizeDetector__default['default'], {
        handleHeight: true,
        handleWidth: true,
    ...
    value: function renderMap() {
      ...
      var backgroundLayersSource = _isArray2__default['default'](this.props.backgroundLayer) ? this.props.backgroundLayer : [this.props.backgroundLayer];
      ...
      if (this.props.debugTileGrid) {
        ...
        var tileGridLayer = /*#__PURE__*/React__default['default'].createElement(reactLeaflet.Pane, {
          key: 'tilegrid',
          style: {
      ...
      return /*#__PURE__*/React__default['default'].createElement(reactLeaflet.Map, {
        ...
        crs: this.state.crs,
        animate: false
      }, /*#__PURE__*/React__default['default'].createElement(reactLeaflet.Pane, {
        style: {
    ...
    value: function getVectorLayer(layer, i, zIndex, zoom) {
      return /*#__PURE__*/React__default['default'].createElement(VectorLayer, {
        key: layer.key || i,
    ...
    value: function getTileGridLayer(layer, i, zIndex, zoom) {
      return /*#__PURE__*/React__default['default'].createElement(TileGridLayer$1, {
        key: layer.key || i,
        layerKey: layer.layerKey || layer.key,
        uniqueLayerKey: layer.key || i,
        view: this.state.view || this.props.view,
    ...
    value: function getTileLayer(layer, i) {
      ...
      return /*#__PURE__*/React__default['default'].createElement(reactLeaflet.TileLayer, _extends({
        key: layer.key || i,
        url: url
      }, restOptions));
    }
    ...
    value: function getWmsTileLayer(layer, i) {
      ...
      return /*#__PURE__*/React__default['default'].createElement(WMSLayer$1, {
        key: layer.key || i,
        url: o.url,
        crs: crs,
...
ReactLeafletMap.propTypes = {
  backgroundLayer: PropTypes__default['default'].oneOfType([PropTypes__default['default'].object, PropTypes__default['default'].array]),
  name: PropTypes__default['default'].string,
  crs: PropTypes__default['default'].string,
  layers: PropTypes__default['default'].array,
  mapKey: PropTypes__default['default'].string.isRequired,
  onClick: PropTypes__default['default'].func,
  onLayerClick: PropTypes__default['default'].func,
  onViewChange: PropTypes__default['default'].func,
  resources: PropTypes__default['default'].object,
  view: PropTypes__default['default'].object,
  viewLimits: PropTypes__default['default'].object,
  debugTileGrid: PropTypes__default['default'].oneOfType([PropTypes__default['default'].bool, PropTypes__default['default'].shape({
...
var SimpleLayersControl = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(SimpleLayersControl, [{
    ...
    key: "render",
    value: function render() {
      var buttonClasses = classnames__default['default']('ptr-simple-layers-control control', {
        open: this.state.open
      });
      return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    value: function renderMenu() {
      ...
      if (layers) {
        ...
        var menuClasses = classnames__default['default']('ptr-simple-layers-control-menu', {
          open: this.state.open,
    ...
    value: function renderTile(layer, width, height, margin) {
      ...
      var classes = classnames__default['default']('ptr-simple-layers-control-tile', {
        active: active
      });
      var style = {
...
var Angle = WorldWind__default['default'].Angle,
    WWMath = WorldWind__default['default'].WWMath;
/**
...
function decorateWorldWindowController (basicController, viewLimits, levelsBased) {
  ...
  var applyLimits = function applyLimits() {
    ...
    if (!levelsBased) {
      var minBoxRange = viewLimits && viewLimits.boxRangeRange && viewLimits.boxRangeRange[0] || ptrCore.mapConstants.minBoxRange;
      var maxBoxRange = viewLimits && viewLimits.boxRangeRange && viewLimits.boxRangeRange[1] || ptrCore.mapConstants.maxBoxRange;
...
var VectorLayer$1 = /*#__PURE__*/function (_WorldWind$Renderable) {
  ...
  _createClass(VectorLayer, [{
    ...
    value: function addFeatures(features) {
      ...
      var parser = new WorldWind__default['default'].GeoJSONParser(geojson);

      var shapeConfigurationCallback = function shapeConfigurationCallback(geometry, properties) {
        var _this2$pantherProps$h;

        var defaultStyleObject = utils__default['default'].mapStyle.getStyleObject(properties, _this2.pantherProps.style || constants.vectorFeatureStyle.defaultFull);
    ...
    value: function updateHoveredFeatures(fids) {
      ...
      this.renderables.forEach(function (renderable) {
        ...
        if (_includes2__default['default'](fids, key)) {
    ...
    value: function getStyleDefinition(styleObject) {
      ...
      if (styleObject.fill) {
        var fillRgb = utils__default['default'].mapStyle.hexToRgb(styleObject.fill);
        style.interiorColor = new WorldWind__default['default'].Color(fillRgb.r / 255, fillRgb.g / 256, fillRgb.b / 256, styleObject.fillOpacity || 1);
      } else {
        style.interiorColor = WorldWind__default['default'].Color.TRANSPARENT;
      }

      if (styleObject.outlineColor && styleObject.outlineWidth) {
        var outlineRgb = utils__default['default'].mapStyle.hexToRgb(styleObject.outlineColor);
        style.outlineColor = new WorldWind__default['default'].Color(outlineRgb.r / 255, outlineRgb.g / 256, outlineRgb.b / 256, styleObject.outlineOpacity || 1);
        style.outlineWidth = styleObject.outlineWidth;
      } else {
        style.outlineColor = WorldWind__default['default'].Color.TRANSPARENT;
      }
    ...
    value: function getSelection(renderable) {
      if (this.pantherProps.selected) {
        ...
        _forIn2__default['default'](this.pantherProps.selected, function (selection, key) {
          if (selection.keys && _includes2__default['default'](selection.keys, featureKey)) {
  ...
  return VectorLayer;
}(WorldWind__default['default'].RenderableLayer);

var Location = WorldWind__default['default'].Location,
    Sector = WorldWind__default['default'].Sector,
    MercatorTiledImageLayer = WorldWind__default['default'].MercatorTiledImageLayer;
/**
...
var ArgumentError = WorldWind__default['default'].ArgumentError,
    Logger = WorldWind__default['default'].Logger;
...
var WmsLayer = /*#__PURE__*/function (_WorldWind$WmsLayer) {
  ...
  function WmsLayer(layer) {
    ...
    var worldWindOptions = {
      ...
      layerNames: layers,
      levelZeroDelta: new WorldWind__default['default'].Location(45, 45),
      name: name,
      numLevels: 18,
      opacity: opacity || 1,
      params: _isEmpty2__default['default'](params) ? null : params,
      sector: new WorldWind__default['default'].Sector(-90, 90, -180, 180),
      service: options.url,
      size: 256,
      styleNames: styles,
  ...
  _createClass(WmsLayer, [{
    key: "doRender",
    value: function doRender(dc) {
      WorldWind__default['default'].WmsLayer.prototype.doRender.call(this, dc);
      dc.screenCreditController.clear();
    }
  }]);

  return WmsLayer;
}(WorldWind__default['default'].WmsLayer);
...
var WmtsLayer = /*#__PURE__*/function (_OsmLayer) {
  ...
  _createClass(WmtsLayer, [{
    ...
    value: function urlForTile(url, tile, imageFormat) {
      var template = uriTemplates__default['default'](url);
      ...
      if (template && template.varNames && template.varNames.length) {
        ...
        return "".concat(url, "/").concat(tile.level.levelNumber + 1, "/").concat(tile.column, "/").concat(tile.row, ".").concat(WorldWind__default['default'].WWUtil.suffixForMimeType(imageFormat));
      }
    }
  }]);
...
var LargeDataLayerTile = /*#__PURE__*/function () {
  function LargeDataLayerTile(data, options, style, fidColumnName, selected, hovered) {
    ...
    if (this._hovered && this._hovered.keys) {
      this._hoveredStyle = utils.mapStyle.getStyleObject(null, this._hovered.style, true); // todo add default
    }

    if (selected && !_isEmpty2__default['default'](selected)) {
      var sel = [];

      _forIn2__default['default'](selected, function (selectedDef) {
        if (selectedDef && !_isEmpty2__default['default'](selectedDef)) {
          sel.push({
            keys: selectedDef.keys,
            style: utils.mapStyle.getStyleObject(null, selectedDef.style, true) // todo add default
  ...
  _createClass(LargeDataLayerTile, [{
    ...
    value: function shape(context, data, hovered, selected) {
      ...
      var style = utils.mapStyle.getStyleObject(attributes, this._style); // apply hovered style, if feature is hovered
    ...
    value: function getSize(style) {
      if (style.size) {
        ...
        return utils.mapStyle.DEFAULT_SIZE;
      }
    }
  }, {
...
var Location$1 = WorldWind__default['default'].Location,
    REDRAW_EVENT_TYPE = WorldWind__default['default'].REDRAW_EVENT_TYPE,
    Sector$1 = WorldWind__default['default'].Sector;
    WorldWind__default['default'].SurfaceCircle;
    var TiledImageLayer = WorldWind__default['default'].TiledImageLayer; // It supports GeoJSON as format with only points and maximum 1 000 000 points.
...
var LargeDataLayer = /*#__PURE__*/function (_TiledImageLayer) {
  ...
  function LargeDataLayer(wwd, options, layer) {
    ...
    _this.quadTree = new jsQuadtree.QuadTree(new jsQuadtree.Box(0, 0, 360, 180));
    _this.pantherProps = {
      features: options.features,
      fidColumnName: options.fidColumnName,
      hovered: _objectSpread2({}, options.hovered),
      ...
      onHover: options.onHover,
      onClick: options.onClick,
      pointHoverBuffer: options.pointHoverBuffer || utils.mapStyle.DEFAULT_SIZE,
      style: options.style,
      wwd: wwd
    };
  ...
  _createClass(LargeDataLayer, [{
    ...
    value: function addFeatures(features) {
      ...
      features.forEach(function (feature) {
        ...
        if (type === 'Point') {
          ...
          point = new jsQuadtree.Point(feature.geometry.coordinates[0] + 180, feature.geometry.coordinates[1] + 90, props);
        } else if (type === 'MultiPoint') {
          var coordinates = feature.geometry.coordinates[0];
          props.centroid = coordinates;
          point = new jsQuadtree.Point(coordinates[0] + 180, coordinates[1] + 90, props);
        } else if (type === 'MultiPolygon') {
          var centroid = turfCentroid__default['default'](feature.geometry);
          props.centroid = centroid.geometry.coordinates;
          point = new jsQuadtree.Point(centroid.geometry.coordinates[0] + 180, centroid.geometry.coordinates[1] + 90, props);
        }
    ...
    value: function handleEvent(wwd, event) {
      ...
      if (terrainObject) {
        ...
        var points = this.quadTree.query(new jsQuadtree.Circle(position.longitude + 180, position.latitude + 90, buffer)); // find nearest

        if (points.length > 1) {
          var targetPoint = helpers$2.point([position.longitude, position.latitude]);
          var features = points.map(function (point) {
            return helpers$2.point([point.data.centroid[0], point.data.centroid[1]], _objectSpread2({}, point));
          });
          var featureCollection = helpers$2.featureCollection(features);
          var nearest = nearestPoint__default['default'](targetPoint, featureCollection);
    ...
    value: function onMouseMoveResult(data) {
      ...
      if (this.pantherProps.onHover) {
        var gids = _compact2__default['default'](data.points.map(function (point) {
    ...
    value: function filterGeographically(sector) {
      ...
      return this.quadTree.query(new jsQuadtree.Box(sector.minLongitude + 180, sector.minLatitude + 90, width, height));
    }
  }, {
    ...
    value: function updateHoveredKeys(hoveredKeys, x, y) {
      ...
      if (terrainObject) {
        ...
        _each2__default['default'](this.currentTiles, function (tile) {
          var s = tile.sector;
    ...
    switch (layerDefinition.type) {
      case 'worldwind':
        switch (layerDefinition.options.layer) {
          case 'bingAerial':
            return new WorldWind__default['default'].BingAerialLayer(null);

          case 'bluemarble':
            return new WorldWind__default['default'].BMNGLayer();
...
function getVectorLayer(layerDefinition, wwd, onHover, onClick, pointAsMarker) {
  ...
  if (url || pointAsMarker) {
    options.pointHoverBuffer = utils.mapStyle.DEFAULT_SIZE; // in px TODO pass pointHoverBuffer
...
function updateVectorLayer(layerDefinition, wwd, onHover, onClick) {
  ...
  var worldWindLayer = _find2__default['default'](wwd.layers, function (lay) {
...
var HoverContext$1 = Context__default['default'].getContext('HoverContext');
var WorldWindow = WorldWind__default['default'].WorldWindow,
    ElevationModel = WorldWind__default['default'].ElevationModel;
...
var WorldWindMap = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function WorldWindMap(props) {
    ...
    _this = _super.call(this, props);
    _this.canvasId = utils.utils.uuid();
    _this.state = {
      width: null,
      height: null
    };
  ...
  _createClass(WorldWindMap, [{
    ...
    value: function componentDidMount() {
      ...
      new utils.CyclicPickController(this.wwd, ['mousemove', 'mousedown', 'mouseup', 'mouseout', 'touchstart', 'touchmove', 'touchend'], this.onWorldWindHover, true);
      this.updateNavigator(ptrCore.mapConstants.defaultMapView);
      this.updateLayers();
    }
  }, {
    ...
    value: function onZoomLevelsBased(e) {
      ...
      if (e.wheelDelta) {
        ...
        this.onZoomLevelsBasedTimeout = setTimeout(function () {
          var zoomLevel = utils.map.view.getZoomLevelFromBoxRange(_this2.props.view.boxRange, _this2.state.width, _this2.state.height);
          ...
          var levelsRange = ptrCore.mapConstants.defaultLevelsRange;
          var boxRangeRange = _this2.props.viewLimits && _this2.props.viewLimits.boxRangeRange;
          var maxLevel = boxRangeRange && boxRangeRange[0] ? utils.map.view.getZoomLevelFromBoxRange(boxRangeRange[0], _this2.state.width, _this2.state.height) : levelsRange[1];
          var minLevel = boxRangeRange && boxRangeRange[1] ? utils.map.view.getZoomLevelFromBoxRange(boxRangeRange[1], _this2.state.width, _this2.state.height) : levelsRange[0];
          ...
          var boxRange = utils.map.view.getBoxRangeFromZoomLevel(finalZoomLevel, _this2.state.width, _this2.state.height);
    ...
    value: function componentDidUpdate(prevProps) {
      if (prevProps) {
        ...
        if (this.context && this.context.hoveredItems) {
          var currentHoveredItemsString = JSON.stringify(_sortBy2__default['default'](this.context.hoveredItems));
    ...
    value: function updateLayers() {
      ...
      if (this.props.backgroundLayer) {
        ...
        var backgroundLayers = _isArray2__default['default'](this.props.backgroundLayer) ? this.props.backgroundLayer : [this.props.backgroundLayer];
    ...
    value: function updateHoveredFeatures() {
      ...
      this.wwd.redraw();
      this.previousHoveredItemsString = JSON.stringify(_sortBy2__default['default'](this.context.hoveredItems));
    }
  }, {
    key: "updateNavigator",
    ...
    value: function onNavigatorChange(event) {
      ...
      if (event) {
        ...
        var changedViewParams = navigator.getChangedViewParams(_objectSpread2(_objectSpread2({}, ptrCore.mapConstants.defaultMapView), this.props.view), viewParams);

        if (this.props.onViewChange) {
          if (!_isEmpty2__default['default'](changedViewParams)) {
    ...
    value: function onWorldWindHover(renderables, event) {
      ...
      if (renderables.length && renderables.length === 1) {
        ...
        if (event.type === 'mousedown' && layerPantherProps.selectable) {
          ...
          this.onLayerHover(layerPantherProps.layerKey, featureKeys, event.pageX, event.pageY, /*#__PURE__*/React__default['default'].createElement("div", null, featureKeys.join(',')), data, layerPantherProps.fidColumnName);
        }
...
WorldWindMap.propTypes = {
  ...
  onLayerClick: PropTypes__default['default'].func,
  onViewChange: PropTypes__default['default'].func,
  elevationModel: PropTypes__default['default'].string
};
...
var LoadableMapControls = Loadable__default['default']({
  loader: function loader() {
    return ptrCore.isServer ? Promise.resolve().then(function () { return presentationEmpty; }) : Promise.resolve().then(function () { return index; });
  },
  render: function render(loaded, props) {
    var MapControls = loaded["default"];
    return /*#__PURE__*/React__default['default'].createElement(MapControls, props);
  },
...
var isomorphicLoadableMapControls = function isomorphicLoadableMapControls(props) {
  return ptrCore.isServer ? /*#__PURE__*/React__default['default'].createElement(PresentationEmpty, null) : /*#__PURE__*/React__default['default'].createElement(LoadableMapControls, props);
};
...
var LoadableMapSet = Loadable__default['default']({
  loader: function loader() {
    return ptrCore.isServer ? Promise.resolve().then(function () { return presentationEmpty$1; }) : Promise.resolve().then(function () { return index$1; });
  },
  render: function render(loaded, props) {
    var MapSet = loaded["default"];
    return /*#__PURE__*/React__default['default'].createElement(MapSet, props);
  },
  loading: function loading(props) {
    if (props.error) {
      return /*#__PURE__*/React__default['default'].createElement("span", null, "Error!");
    } else {
      return /*#__PURE__*/React__default['default'].createElement("span", null, "Loading...");
    }
  }
});

var isomorphicMapSet = function isomorphicMapSet(props) {
  return ptrCore.isServer ? /*#__PURE__*/React__default['default'].createElement(PresentationEmpty$1, null) : /*#__PURE__*/React__default['default'].createElement(LoadableMapSet, props);
};

var LoadableReactLeafletMap = Loadable__default['default']({
  loader: function loader() {
    return ptrCore.isServer ? Promise.resolve().then(function () { return presentationEmpty$1; }) : Promise.resolve().then(function () { return index$2; });
  },
  render: function render(loaded, props) {
    var ReactLeafletMap = loaded["default"];
    return /*#__PURE__*/React__default['default'].createElement(ReactLeafletMap, props);
  },
  loading: function loading(props) {
    if (props.error) {
      return /*#__PURE__*/React__default['default'].createElement("div", null, "Error!");
...
var isomorphicLoadableReactLeafletMap = function isomorphicLoadableReactLeafletMap(props) {
  return ptrCore.isServer ? /*#__PURE__*/React__default['default'].createElement(PresentationEmpty$1, null) : /*#__PURE__*/React__default['default'].createElement(LoadableReactLeafletMap, props);
};

var LoadableMap = Loadable__default['default']({
  loader: function loader() {
    return ptrCore.isServer ? Promise.resolve().then(function () { return presentationEmpty$1; }) : Promise.resolve().then(function () { return _Map; });
  },
  render: function render(loaded, props) {
    var PresentationMap = loaded["default"];
    return /*#__PURE__*/React__default['default'].createElement(PresentationMap, props);
  },
  loading: function loading(props) {
    if (props.error) {
      return /*#__PURE__*/React__default['default'].createElement("span", null, "Error!");
...
var isomorphicMap = function isomorphicMap(props) {
  return ptrCore.isServer ? /*#__PURE__*/React__default['default'].createElement(PresentationEmpty$1, null) : /*#__PURE__*/React__default['default'].createElement(LoadableMap, props);
};
...
exports.LoadableMap = isomorphicMap;
exports.LoadableMapControls = isomorphicLoadableMapControls;
exports.LoadableMapSet = isomorphicMapSet;
exports.LoadableReactLeafletMap = isomorphicLoadableReactLeafletMap;
...
exports.PresentationMap = PresentationMap$1;
exports.ReactLeafletMap = ReactLeafletMap;
exports.SimpleLayersControl = SimpleLayersControl;
exports.WorldWindMap = WorldWindMap;
